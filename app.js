        var I18N = JSON.parse('{"html_lang": "fr", "toggle_sidebar_title": "Afficher / masquer le panneau", "base_configured": "Base configurée", "legend_title": "Légende &amp; Couches", "expand_all": "▾ Tout déplier", "collapse_all": "▸ Tout replier", "filter_title": "🔎 Filtre par attribut", "filter_layer_label": "Couche", "filter_choose_layer": "-- Choisir une couche --", "filter_field_label": "Champ", "filter_choose_field": "-- Choisir un champ --", "filter_operator_label": "Opérateur", "filter_value_label": "Valeur", "op_eq": "= (égal à)", "op_neq": "≠ (différent de)", "op_contains": "⊃ contient", "op_starts": "commence par", "op_gt": "&gt; (supérieur à)", "op_lt": "&lt; (inférieur à)", "op_gte": "≥ (supérieur ou égal)", "op_lte": "≤ (inférieur ou égal)", "filter_value_placeholder": "Saisir ou cliquer une valeur...", "apply": "✔ Appliquer", "reset": "✖ Réinitialiser", "collapse_toggle_title": "Replier / déplier", "cluster_points_label": "Regrouper les points (cluster)", "no_entity_found": "⚠ Aucune entité trouvée.", "choose_layer_and_field": "⚠ Choisissez une couche et un champ.", "data_not_loaded": "⚠ Données non encore chargées.", "entities_found_prefix": "entité(s) trouvée(s) sur", "entities_highlighted_suffix": "— sélectionnée(s) en surbrillance sur la carte.", "my_position": "Ma position", "fullscreen_title": "Plein écran", "fullscreen_cancel": "Quitter", "search_placeholder": "Rechercher une adresse...", "print_title": "Imprimer la carte"}');
        var metaCouches = JSON.parse('{"Assurés vivant avec un handicap": {"fichier": "data/Assur_s_vivant_avec_un_handicap.geojson", "geom_type": 0, "popup_fields": ["Caisse", "Commune", "Adresse"], "legend_style": [{"valeur": "default", "label": "Assurés vivant avec un handicap", "img_path": "styles_images/icon_Assur_s_vivant_avec_un_handicap_unique.png"}], "is_polygon": false, "is_line": false, "is_point": true, "etiquette": null, "attr_classif": null}, "Centre-Val de Loire": {"fichier": "data/Centre-Val_de_Loire.geojson", "geom_type": 2, "popup_fields": ["ID", "NOM_M", "NOM", "INSEE_REG"], "legend_style": [], "is_polygon": true, "is_line": false, "is_point": false, "etiquette": null, "attr_classif": null}, "Cabinets de médecins généralistes": {"fichier": "data/Cabinets_de_m_decins_g_n_ralistes.geojson", "geom_type": 0, "popup_fields": ["N° RPPS", "Nom", "Prénom", "Profession", "Adresse"], "legend_style": [{"valeur": "default", "label": "Cabinets de médecins généralistes", "img_path": "styles_images/icon_Cabinets_de_m_decins_g_n_ralistes_unique.png"}], "is_polygon": false, "is_line": false, "is_point": true, "etiquette": null, "attr_classif": null}, "Cabinets infirmiers": {"fichier": "data/Cabinets_infirmiers.geojson", "geom_type": 0, "popup_fields": ["N° RPPS", "Nom", "Prénom", "Profession", "Adresse"], "legend_style": [{"valeur": "default", "label": "Cabinets infirmiers", "img_path": "styles_images/icon_Cabinets_infirmiers_unique.png"}], "is_polygon": false, "is_line": false, "is_point": true, "etiquette": null, "attr_classif": null}, "Trajets de transport en commun vers les MG": {"fichier": "data/Trajets_de_transport_en_commun_vers_les_MG.geojson", "geom_type": 1, "popup_fields": ["Commune du patient", "Distance euclidienne (en km)", "Distance du trajet (en km)", "Durée du trajet (en min)", "Marchabilité (en m)", "modes"], "legend_style": [{"valeur": "default", "label": "Trajets de transport en commun vers les MG", "img_path": "styles_images/icon_Trajets_de_transport_en_commun_vers_les_MG_unique.png"}], "is_polygon": false, "is_line": true, "is_point": false, "etiquette": null, "attr_classif": null}, "Potentiels déplacements des infirmiers (max 8 km)": {"fichier": "data/Potentiels_d_placements_des_infirmiers_max_8_km.geojson", "geom_type": 1, "popup_fields": ["Commune du patient", "Cabinet de ville", "Distance euclidienne (en km)", "Distance du trajet (en km)", "Durée du trajet (en min)"], "legend_style": [{"valeur": "default", "label": "Potentiels déplacements des infirmiers (max 8 km)", "img_path": "styles_images/icon_Potentiels_d_placements_des_infirmiers_max_8_km_unique.png"}], "is_polygon": false, "is_line": true, "is_point": false, "etiquette": null, "attr_classif": null}, "Trajets en voiture vers les MG": {"fichier": "data/Trajets_en_voiture_vers_les_MG.geojson", "geom_type": 1, "popup_fields": ["Commune du patient", "Cabinet de ville", "Distance euclidienne (en km)", "Distance du trajet (en km)", "Durée du trajet (en min)"], "legend_style": [{"valeur": "default", "label": "Trajets en voiture vers les MG", "img_path": "styles_images/icon_Trajets_en_voiture_vers_les_MG_unique.png"}], "is_polygon": false, "is_line": true, "is_point": false, "etiquette": null, "attr_classif": null}}');
        ...
        if (typeof L.control.fullscreen !== 'undefined') { L.control.fullscreen({ title: "Plein écran", titleCancel: "Quitter" }).addTo(map); }
        ...
        var PrintControl = L.Control.extend({ options: { position: 'topleft' }, onAdd: function() { var c = L.DomUtil.create('div', 'leaflet-bar leaflet-control'); var btn = L.DomUtil.create('a', '', c); btn.innerHTML = '🖨️'; btn.href = '#'; btn.title = "Imprimer la carte"; L.DomEvent.on(btn, 'click', function(e) { L.DomEvent.stop(e); window.print(); }); return c; } }); map.addControl(new PrintControl());
